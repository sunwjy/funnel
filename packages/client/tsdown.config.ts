...
export default defineConfig({
  entry: {
    ...
    "plugins/toss-ads": "src/plugins/toss-ads/index.ts",
    "plugins/reddit-pixel": "src/plugins/reddit-pixel/index.ts",
    "plugins/daangn-ads": "src/plugins/daangn-ads/index.ts",
    "plugins/pinterest-tag": "src/plugins/pinterest-tag/index.ts",
  },
  format: ["esm", "cjs"],
  target: "es2020",
  dts: true,
